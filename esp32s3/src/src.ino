...
static void parseData()
{
      ...
      switch(cmd){
        ...
        case 2: esp32s3_tone(getByte(0),getShort(1),getShort(2));; callOK(); break;
        case 3: sendByte((pinMode(getByte(0),INPUT_PULLUP),digitalRead(getByte(0)))); break;
        case 4: sendShort((esp32s3_analogRead(getByte(0),getShort(1)))); break;
        case 5: showLED(getShort(0),getShort(1),getShort(2));; callOK(); break;
        #if defined(ESP32)
